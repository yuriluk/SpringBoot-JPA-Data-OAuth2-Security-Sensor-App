...
import org.example.sensor.security.exception.BadRequestException;
...
import static org.example.sensor.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    private boolean isAuthorizedRedirectUri(String uri) {
        ...
        for (String s : authorizedRedirectUris) {
